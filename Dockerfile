...
# copy source laravel
COPY . .
COPY --from=frontend_builder /var/www/php/public/css public/css
COPY --from=frontend_builder /var/www/php/public/fonts public/fonts
COPY --from=frontend_builder /var/www/php/public/js public/js
